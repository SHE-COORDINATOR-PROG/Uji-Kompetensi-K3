...
export default async function handler(req, res) {
  ...
  try {
    ...
    if (req.method === 'POST') {
      const { id, nama, nrp, kategoriId, kategoriNama, tanggal, skor, lulus } = req.body || {};
      ...
      await sql`
        INSERT INTO exam_records (id, nama, nrp, kategori_id, kategori_nama, tanggal, skor, lulus)
        VALUES (${id}, ${nama}, ${nrp}, ${kategoriId}, ${kategoriNama}, ${tanggal}, ${skor}, ${lulus})
